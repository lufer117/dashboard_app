...
This is a generalized version of a Streamlit dashboard developed to analyze product movement, restocking efficiency, out-of-stock patterns, and performance indexes across multiple shelfs and SKUs in retail environments.
...
- **Product Consumption Overview**: Total pulls by location, SKU, and shelfs.
- **Product Velocity**: Pulls per day (active vs full period), including shelf- and shelf-level detail.
- **Restocking Metrics**: Frequency, average fill volume, and time between restocks.
- **Out-of-Stock (OOS) Monitoring**: Tracks duration and frequency of OOS events by SKU and shelf.
